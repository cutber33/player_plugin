...
export class TimeSlider {
    configure(configuration) {
        ...
        let startTimeRounded = this.roundtoInterval(this.startTime, this.interval, this.first);
        ...
        let endTimeRounded = this.roundtoInterval(this.endTime, this.interval, this.first);
        ...
        */
        ...
        backwardsButton.addEventListener("click", (event) => {
            this.onBackwards();
        });
    ...
    onPickedTimestamp(click) {
        ...
        let offsetLeft = controlBar.offsetLeft +
            progress.offsetLeft +
            (slider.offsetLeft - span.offsetLeft);
        let posX = click.pageX - offsetLeft;
        let newTimestamp = this.first + (posX / slider.offsetWidth) * (this.last - this.first);
    ...
    setTimestamp(newTimestamp) {
        ...
        document.getElementById("currentTime").innerHTML =
            this.getDay(this.shown) + ", " + this.getTime(this.shown);
        let progressWidth = (1 - (self.last - self.shown) / (self.last - self.first)) * 100;
